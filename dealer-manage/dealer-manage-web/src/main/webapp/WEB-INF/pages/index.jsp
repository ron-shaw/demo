    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="nav-header">
                    <div class="profile-element" style="font-size: large; color: #a7b1c2;">
                        <span>经销商后台管理系统</span>
                    </div>
                    <div class="logo-element">DM
                    </div>
                </li>
                <%--menu start--%>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <c:forEach items="${menu.submenus}" var="child">
                                <li>
                                    <a target="_blank" class="J_menuItem" href="${child.link}"
                                       data-index="${child.link}">${child.name}</a>
                                </li>
                            </c:forEach>
                        </ul>
